...
//  TESLocationMgr.h
//
//  Created by Phillp Frantz on 18/12/12.
...
- (void) writeDebugInfo:(nullable CLLocationManager *)manager newLocation:(nullable CLLocation *)newLocation;
...
- (nullable NSArray *) readDebugInfo;
- (void) clearDebugInfo;
